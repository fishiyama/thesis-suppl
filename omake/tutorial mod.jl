...
xlabel("sample no.",fontsize=14); ylabel("amplitude",fontsize=14); 
xticks(fontsize = 11); yticks(fontsize = 11);
legend(fontsize=11); show();
...
xlabel("frequency", fontsize=14); ylabel("amplitude", fontsize=14);
xticks(fontsize = 11); yticks(fontsize = 11);
yscale("log"); legend(fontsize=11); show(); 
